...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
  ...
  <h6 className="tracking-tight text-slate-900 capitalize truncate">{pro.productDescription}</h6>
          ...
          <div className="mt-2 mb-5 flex items-center justify-between">
            <p>
              <span className="text-3xl font-bold text-slate-900">Rs.{pro.productPrice}</span>
              <span className="text-sm text-slate-900 line-through">Rs.699</span>
            </p>
          ...
          <button onClick={()=> addToCart(pro)} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
