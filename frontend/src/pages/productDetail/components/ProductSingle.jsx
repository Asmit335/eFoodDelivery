...
const ProductSingle = ({id:productId}) => {
  ...
  <div className="container mx-auto px-4 py-8">
    <div className="flex flex-wrap -mx-4">
        ...
        <img src={selectSingleProduct.productImage} alt="Product" className="w-100 rounded-lg mb-4rounded-lg shadow-md ml-12" productId="mainImage"/>
        <div className="flex gap-4 py-4 justify-center overflow-x-auto">
        </div>
      </div>
      <div className="w-full md:w-1/2 px-4">
        <h2 className="text-3xl font-bold mb-2 uppercase">{selectSingleProduct.productName}</h2>
        <div className="mb-4">
          <span className="text-2xl font-bold mr-2">Rs.{selectSingleProduct.productPrice}</span>
        ...
        <p className="text-gray-700 mb-6 ">{selectSingleProduct.productDescription}</p>

        <p className="text-gray-600 mb-4 capitalize">
          <span className=' text-green-700'>Status: </span>{selectSingleProduct.productStatus}
        </p>
        <p className="text-gray-600 mb-4 capitalize">
          Stock Left: {selectSingleProduct.productStockQuantity} Qty
        </p>
        ...
        <div className="mb-6">
          ...
          <input type="number" id={productId} name="quantity" min="1" value="1"
        ...
        <div>
          ...
          <ul className="list-disc list-insproductIde text-gray-700">
